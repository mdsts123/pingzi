...
class EyxqqsmController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Eyxqqsm'")->find();//->cache('Bsqqsm_conf')
    }
    ...
    public function pay() {
        ...
        $data = array(
            ...
            "returnUrl" => U('Eyxqqsm/hrefback', '',false,true),
            "notifyUrl" => U('Eyxqqsm/notify', '',false,true),
            "orderNo" => $orderno,
            "title" => '快充',
            "body" => '快充-QQ扫码',
