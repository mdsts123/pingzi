...
class LuobofuwxController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Luobofuwx_conf')->where("payclass='Luobofuwx'")->find();
    }
    public function pay() {
       ...
       $data = array(
           ...
           'callbackurl'=>U('Luobofuwx/notify','',true,true),
           'hrefbackurl'=>U('Luobofuwx/hrefback','',true,true),
           'payerIp'=>$order['ip'],
           'attach'=>''
       );
       $temp='';
