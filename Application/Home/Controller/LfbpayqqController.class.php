...
class LfbpayqqController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Lfbpayqq_conf')->where("payclass='Lfbpayqq'")->find();
        //print_r($this->conf);
    }
    public function pay() {
      ...
      if(isMobile()){
        ...
        // 商户通知地址
        $data['notifyUrl'] = U('Lfbpayqq/notify','',true,true);
        // 商户扩展字段
        ...
        $data['typeId'] = 3;//1；支付宝 2；微信 3；QQ钱包
