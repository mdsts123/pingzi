...
class BsupsmController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Bsupsm'")->find();//->cache('Bsupsm_conf')
    }
    ...
    public function pay() {
        ...
        $data = array(
			...
			'PaymentTypeCode' => 'UNIONPAY_QRCODE_PAY',
			'OutPaymentNo' => $order['orderno'],
			'PaymentAmount' => sprintf('%s',$order['amount']*100),
			'NotifyUrl' => U('Bsupsm/notify', '',false,true),
