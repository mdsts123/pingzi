...
class BsjdsmController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Bsjdsm'")->find();//->cache('Bsjdsm_conf')
    }
