...
class EyxjdsmController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Eyxjdsm'")->find();//->cache('Bsqqsm_conf')
    }
    ...
    public function pay() {
        ...
        $data = array(
            ...
            "returnUrl" => U('Eyxjdsm/hrefback', '',false,true),
            "notifyUrl" => U('Eyxjdsm/notify', '',false,true),
            "orderNo" => $orderno,
            "title" => '快充',
            "body" => '快充-京东扫码',
