...
class HaolianzfController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Haolianzf_conf')->where("payclass='Haolianzf'")->find();
    }
    public function pay() {
        $type = I('type','','trim');
       ...
       $data['notifyurl'] = U('Haolianzf/notify','',true,true);//异步通知
       $data['returnurl'] = U('Haolianzf/hrefback','',true,true);//异步通知
       $data['paytype'] = 'alipay';
       $data['remark'] = '';
       $data['get_code'] = '';
       $data['bankcode'] = '';
