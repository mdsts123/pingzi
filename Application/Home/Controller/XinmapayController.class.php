...
class XinmapayController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Xinmapay_conf')->where("payclass='Xinmapay'")->find();
    }
    public function pay(){
       ...
       $reqData = array(
           ...
           'back_notify_url'   => U('Xinmapay/notify','',true,true),
