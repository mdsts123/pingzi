...
class HaolianqqController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Haolianqq_conf')->where("payclass='Haolianqq'")->find();
    }
    public function pay() {
        $type = I('type','','trim');
       ...
       $data['notifyurl'] = U('Haolianqq/notify','',true,true);//异步通知
       $data['returnurl'] = U('Haolianqq/hrefback','',true,true);//异步通知
       $data['paytype'] = 'qq';
       $data['remark'] = '';
       $data['get_code'] = '';
       $data['bankcode'] = '';
