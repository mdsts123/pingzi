...
class HuihewxController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Huihewx_conf')->where("payclass='Huihewx'")->find();
    }
    public function pay() {
       ...
       $data["NotifyUrl"] = U('Huihewx/notify','',true,true);//异步通知
