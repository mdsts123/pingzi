...
class YmfwyController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Ymfwy'")->find();//->cache('Ymfwy_conf')
    }
    ...
    public function pay()
	{
		...
		if (isMobile()) {
			$data = array(
					...
					'tradeDate' => date("Ymd"),
					'amt' => $order['amount'],
					'merchUrl' => U('Ymfwy/notify', '', false, true),
					'merchParam' => 'abcd',
