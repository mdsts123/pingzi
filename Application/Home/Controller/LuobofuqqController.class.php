...
class LuobofuqqController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Luobofuqq_conf')->where("payclass='Luobofuqq'")->find();
    }
    public function pay() {
       ...
       $data = array(
           ...
           'callbackurl'=>U('Luobofuqq/notify','',true,true),
           'hrefbackurl'=>U('Luobofuqq/hrefback','',true,true),
           'payerIp'=>$order['ip'],
           'attach'=>''
       );
       $temp='';
