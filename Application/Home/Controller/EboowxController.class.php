...
class EboowxController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Eboowx_conf')->where("payclass='Eboowx'")->find();
    }
    public function pay() {
       ...
       $jsapi = array(
           ...
           "pay_bankcode" => "WXZF",
           "pay_notifyurl" => U('Eboowx/notify','',true,true),
       );
       ...
       $ret = $this->buildForm($jsapi,"http://sapi.eboopay.com/Pay_Index.html");
       die($ret);
