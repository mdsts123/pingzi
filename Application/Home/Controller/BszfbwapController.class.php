...
class BszfbwapController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Bszfbwap'")->find();//->cache('Bszfbwap_conf')
    }
    ...
    public function pay() {
        ...
        $data = array(
			...
			'PaymentTypeCode' => 'ALIPAY_WAP_PAY',
			'OutPaymentNo' => $order['orderno'],
			'PaymentAmount' => sprintf('%s',$order['amount']*100),
			'NotifyUrl' => U('Bszfbwap/notify', '',false,true),
