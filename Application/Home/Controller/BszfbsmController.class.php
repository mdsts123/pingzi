...
class BszfbsmController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Bszfbsm'")->find();//->cache('Bszfbsm_conf')
    }
    ...
    public function pay() {
        ...
        $data = array(
			...
			'PaymentTypeCode' => 'ALIPAY_QRCODE_PAY',
			'OutPaymentNo' => $order['orderno'],
			'PaymentAmount' => sprintf('%s',$order['amount']*100),
			'NotifyUrl' => U('Bszfbsm/notify', '',false,true),
