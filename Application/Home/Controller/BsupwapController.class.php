...
class BsupwapController extends HomeController {
    protected function _initialize(){
        $this->conf = M('Payapi')->where("payclass='Bsupwap'")->find();//->cache('Bsupwap_conf')
    }
    ...
    public function pay() {
        ...
        $data = array(
			...
			'PaymentTypeCode' => 'UNIONPAY_WAP_PAY',
			'OutPaymentNo' => $order['orderno'],
			'PaymentAmount' => sprintf('%s',$order['amount']*100),
			'NotifyUrl' => U('Bsupwap/notify', '',false,true),
