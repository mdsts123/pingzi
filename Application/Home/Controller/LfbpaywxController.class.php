...
class LfbpaywxController extends HomeController {
	protected function _initialize(){
        $this->conf = M('Payapi')->cache('Lfbpaywx_conf')->where("payclass='Lfbpaywx'")->find();
        //print_r($this->conf);
    }
    public function pay() {
      ...
      if(isMobile()){
        ...
        // 商户通知地址
        $data['notifyUrl'] = U('Lfbpaywx/notify','',true,true);
        // 商户扩展字段
        ...
        $data['typeId'] = 2;//1；支付宝 2；微信 3；QQ钱包
