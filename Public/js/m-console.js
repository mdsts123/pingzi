...
function () {
  ...
  _createClass(Utils, [{
    ...
    key: "url2GetFileNmae",
    value: function url2GetFileNmae(str) {
      str += ' '; //加空格方便正则匹配
...
function () {
  ...
  function FormModule() {
    ...
    _defineProperty(this, "eventEl", void 0);
  ...
  _createClass(FormModule, [{
    ...
    value: function watchEvents() {
      var f = this;
      $("[name='commit_type']").on('change', function (e) {
    ...
    key: "handleChangeItemCommitType",
    value: function handleChangeItemCommitType(el) {
    ...
    key: "handleLoaded",
    value: function handleLoaded(form) {
      var formID = _utils.url2GetFileNmae($(form).attr('action'));
