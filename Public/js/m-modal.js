  ...
  (function(_API) {
    ...
    function Modal() {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(Modal).call(this),
      );
      ...
      },
      {
        ...
        value: function renderOption(data, current) {
          return data
            .map(function(opt) {
              return '<option value="'
                .concat(opt.pay_status, '" ')
                .concat(opt.pay_status === current ? 'selected' : '', ' >')
                .concat(opt.pay_status_name, '</option>');
            })
            .join('');
        },
      },
      {
        ...
        value: function renderContent(data) {
          ...
          var html = '\n  <div class="m-modal-content detail">\n  <!-- \u56FE\u7247\u8BE6\u60C5 image-text -->\n  <div class="m-row data-container">\n  <div class="m-col-6 m-img-box">\n    <img src="'
            .concat(
              _utils.nullfy2str(data.img_src),
              '" alt="">\n  </div>\n  <div class="m-col-6 ">\n    <div class="m-debar">\n      <!-- \u5217\u8868 -->\n      <!-- \u56FE\u7247\u6570\u636E -->\n      <div class="m-scroll">\n        <table class="m-table ">\n          <thead>\n            <tr>\n              <th>ID</th>\n              <th>',
            )
            .concat(
              _utils.nullfy2str(data.id),
              '</th>\n            </tr>\n          </thead>\n          <tbody>\n          <tr><td>\u8BA2\u5355\u53F7</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.orderno),
              '</td></tr>\n          <tr><td>\u63D0\u4EA4\u7C7B\u578B</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.commit_type_name),
              '</td></tr>\n          <tr><td>\u652F\u4ED8\u7C7B\u578B</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.pay_type_name),
              '</td></tr>\n          <tr><td>\u4F1A\u5458\u8D26\u53F7</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.username),
              '</td></tr>\n          <tr><td>\u5145\u503C\u91D1\u989D</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.amount),
              '</td></tr>\n          <tr><td>\u8D60\u9001\u91D1\u989D</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.giv_amount),
              '</td></tr>\n          <tr><td>\u72B6\u6001</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.pay_status_name),
              '</td></tr>\n          <tr><td>\u6536\u6B3E\u4EBA</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.collname),
              '</td></tr>\n          <tr><td>\u4ED8\u6B3E\u4EBA</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.payname),
              '</td></tr>\n          <tr><td>\u5907\u6CE8</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.desc),
              '</td></tr>\n          <tr><td>\u63D0\u4EA4\u7528\u6237</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.commitname),
              '</td></tr>\n          <tr><td>\u7EC4\u522B</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.groupname),
              '</td></tr>\n          <tr><td>\u63D0\u4EA4\u65F6\u95F4</td><td>',
            )
            .concat(
              _utils.nullfy2str(data.cmit_time),
