...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/./Application/Admin/View/Public/css/<?php echo C('ADMIN_THEME');?>.css">
...
<body class="<?php echo ($_page_name); ?>">
    ...
    <div class="builder-container">
        ...
        <label class="left control-label"><?php echo ($form["title"]); ?>：</label>
        <div class="right">
            <input type="text" class="form-control input num" name="<?php echo ($form["name"]); ?>" value="<?php echo ($form["value"]); ?>" placeholder="<?php echo ($form["tip"]); ?>" <?php echo ($form["extra"]["attr"]); ?>>
        </div>
    </div><?php break;?>

                                
                                <?php case "uid": ?><div class="form-group item_<?php echo ($form["name"]); ?> <?php echo ($form["extra"]["class"]); ?>">
        <label class="left control-label"><?php echo ($form["title"]); ?>：</label>
        <div class="right">
            <input type="text" class="form-control input text" name="<?php echo ($form["name"]); ?>" value="<?php echo ($form["value"]); ?>" placeholder="<?php echo ($form["tip"]); ?>" <?php echo ($form["extra"]["attr"]); ?>>
        </div>
    </div><?php break;?>

                                
                                <?php case "uids": ?><div class="form-group item_<?php echo ($form["name"]); ?> <?php echo ($form["extra"]["class"]); ?>">
        <label class="left control-label"><?php echo ($form["title"]); ?>：</label>
        <div class="right">
            <input type="text" class="form-control input text" name="<?php echo ($form["name"]); ?>" value="<?php echo ($form["value"]); ?>" placeholder="<?php echo ($form["tip"]); ?>" <?php echo ($form["extra"]["attr"]); ?>>
        </div>
        ...
        <label class="left control-label"><?php echo ($form["title"]); ?>：</label>
        <div class="right">
            <input type="password" class="form-control input password" name="<?php echo ($form["name"]); ?>" value="<?php echo ($form["value"]); ?>" placeholder="<?php echo ($form["tip"]); ?>" <?php echo ($form["extra"]["attr"]); ?>>
        </div>
    </div><?php break;?>
    ...
    <div class="form-group item_<?php echo ($form["name"]); ?> <?php echo ($form["extra"]["class"]); ?>">
        <label class="left control-label"><?php echo ($form["title"]); ?>：</label>
        <div class="right">
            <select multiple="multiple" size="6" name="<?php echo ($form["name"]); ?>[]" class="form-control cui-select select" <?php echo ($form["extra"]["attr"]); ?>>
        ...
        <div class="right">
            <div class="input-group">
                ...
                <input type="text" id="<?php echo ($group_k); ?>_date_<?php echo ($k); ?>" class="form-control input date" name="<?php echo ($form["name"]); ?>" value="
<?php if(!empty($form["value"])): if(is_numeric($form['value'])) { echo time_format($form['value'], 'Y-m-d'); } else { echo $form['value']; } ?>
<?php else: ?>
    <?php echo(date("Y-m-d")); endif; ?>" <?php echo ($form["extra"]["attr"]); ?>>
            </div>
            <script type="text/javascript">
                $(function(){
        ...
        <div class="right">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                <input type="text" id="<?php echo ($group_k); ?>_time_<?php echo ($k); ?>" class="form-control input time" name="<?php echo ($form["name"]); ?>" value="
<?php if(!empty($form["value"])): if(is_numeric($form['value'])) { echo time_format($form['value'], 'Y-m-d H:i:s'); } else { echo $form['value']; } ?>
<?php else: ?>
    <?php echo(date("Y-m-d H:i:s")); endif; ?>" <?php echo ($form["extra"]["attr"]); ?>>
            </div>
            <script type="text/javascript">
                $(function(){
        ...
        <div class="right row">
            <div  id="<?php echo ($group_k); ?>_upload_box_<?php echo ($k); ?>" class="wu-example">
                ...
                <div id="<?php echo ($group_k); ?>_upload_list_<?php echo ($k); ?>" class="uploader-list col-xs-12 img-box">
                    <?php if(!empty($form["value"])): ?><div id="<?php echo ($group_k); ?>_upload_preview_<?php echo ($k); ?>" class="col-sm-3 file-item thumbnail">
                            <i class="fa fa-times-circle remove-picture"></i>
                            <img src="<?php echo (get_cover($form["value"])); ?>" data-id="<?php echo ($form["value"]); ?>">
                        </div>
                    <?php else: ?>
                        <div id="<?php echo ($group_k); ?>_upload_preview_<?php echo ($k); ?>" class="col-sm-3 file-item thumbnail hidden">
                            <i class="fa fa-times-circle remove-picture"></i>
                            <img>
                        </div><?php endif; ?>
                </div>
            ...
            <script type="text/javascript">
                $(function(){
                    var uploader_<?php echo ($group_k); ?>_upload_<?php echo ($k); ?> = WebUploader.create({
                        ...
                        fileSingleSizeLimit:<?php echo $form['extra']['self']['size'] ? : C('UPLOAD_IMAGE_SIZE'); ?>*1024*1024, // 验证单个文件大小是否超出限制, 超出则不允许加入队列
                        // 文件过滤
                        accept: {
                            title: 'Images',
                            extensions: "<?php echo $form['extra']['self']['ext'] ? : 'gif,jpg,jpeg,bmp,png'; ?>",
                    ...
                    // 上传错误
                    uploader_<?php echo ($group_k); ?>_upload_<?php echo ($k); ?>.on("error",function (type){
                ...
                $(function(){
                    KindEditor.ready(function(K) {
                        kindeditor_<?php echo ($k); ?> = K.create('#<?php echo ($group_k); ?>_kindeditor_<?php echo ($k); ?>', {
                            ...
                            filePostName : 'file',
                            cssPath : [
                                '/Public/libs/lyui/dist/css/cui.min.css',
        ...
        <label class="left control-label"><?php echo ($tab_form["title"]); ?>：</label>
        <div class="right">
            <input type="text" class="form-control input num" name="<?php echo ($tab_form["name"]); ?>" value="<?php echo ($tab_form["value"]); ?>" placeholder="<?php echo ($tab_form["tip"]); ?>" <?php echo ($tab_form["extra"]["attr"]); ?>>
        </div>
    </div><?php break;?>

                                                                
                                                                <?php case "uid": ?><div class="form-group item_<?php echo ($tab_form["name"]); ?> <?php echo ($tab_form["extra"]["class"]); ?>">
        <label class="left control-label"><?php echo ($tab_form["title"]); ?>：</label>
        <div class="right">
            <input type="text" class="form-control input text" name="<?php echo ($tab_form["name"]); ?>" value="<?php echo ($tab_form["value"]); ?>" placeholder="<?php echo ($tab_form["tip"]); ?>" <?php echo ($tab_form["extra"]["attr"]); ?>>
        </div>
    </div><?php break;?>

                                                                
                                                                <?php case "uids": ?><div class="form-group item_<?php echo ($tab_form["name"]); ?> <?php echo ($tab_form["extra"]["class"]); ?>">
        <label class="left control-label"><?php echo ($tab_form["title"]); ?>：</label>
        <div class="right">
            <input type="text" class="form-control input text" name="<?php echo ($tab_form["name"]); ?>" value="<?php echo ($tab_form["value"]); ?>" placeholder="<?php echo ($tab_form["tip"]); ?>" <?php echo ($tab_form["extra"]["attr"]); ?>>
        </div>
        ...
        <label class="left control-label"><?php echo ($tab_form["title"]); ?>：</label>
        <div class="right">
            <input type="password" class="form-control input password" name="<?php echo ($tab_form["name"]); ?>" value="<?php echo ($tab_form["value"]); ?>" placeholder="<?php echo ($tab_form["tip"]); ?>" <?php echo ($tab_form["extra"]["attr"]); ?>>
        </div>
    </div><?php break;?>
    ...
    <div class="form-group item_<?php echo ($tab_form["name"]); ?> <?php echo ($tab_form["extra"]["class"]); ?>">
        <label class="left control-label"><?php echo ($tab_form["title"]); ?>：</label>
        <div class="right">
            <select multiple="multiple" size="6" name="<?php echo ($tab_form["name"]); ?>[]" class="form-control cui-select select" <?php echo ($tab_form["extra"]["attr"]); ?>>
        ...
        <div class="right">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                <input type="text" id="tab_<?php echo ($group_k); ?>_date_<?php echo ($tab_k); ?>" class="form-control input date" name="<?php echo ($tab_form["name"]); ?>" value="
<?php if(!empty($tab_form["value"])): if(is_numeric($tab_form['value'])) { echo time_format($tab_form['value'], 'Y-m-d'); } else { echo $tab_form['value']; } ?>
<?php else: ?>
    <?php echo(date("Y-m-d")); endif; ?>" <?php echo ($tab_form["extra"]["attr"]); ?>>
            </div>
            <script type="text/javascript">
                $(function(){
        ...
        <div class="right">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                <input type="text" id="tab_<?php echo ($group_k); ?>_time_<?php echo ($tab_k); ?>" class="form-control input time" name="<?php echo ($tab_form["name"]); ?>" value="
...
<?php else: ?>
    <?php echo(date("Y-m-d H:i:s")); endif; ?>" <?php echo ($tab_form["extra"]["attr"]); ?>>
            </div>
            <script type="text/javascript">
                $(function(){
        ...
        <div class="right row">
            <div  id="tab_<?php echo ($group_k); ?>_upload_box_<?php echo ($tab_k); ?>" class="wu-example">
                ...
                <div id="tab_<?php echo ($group_k); ?>_upload_list_<?php echo ($tab_k); ?>" class="uploader-list col-xs-12 img-box">
                    <?php if(!empty($tab_form["value"])): ?><div id="tab_<?php echo ($group_k); ?>_upload_preview_<?php echo ($tab_k); ?>" class="col-sm-3 file-item thumbnail">
                            <i class="fa fa-times-circle remove-picture"></i>
                            <img src="<?php echo (get_cover($tab_form["value"])); ?>" data-id="<?php echo ($tab_form["value"]); ?>">
                        </div>
                    <?php else: ?>
                        <div id="tab_<?php echo ($group_k); ?>_upload_preview_<?php echo ($tab_k); ?>" class="col-sm-3 file-item thumbnail hidden">
                            <i class="fa fa-times-circle remove-picture"></i>
                            <img>
                        </div><?php endif; ?>
                </div>
            ...
            <script type="text/javascript">
                $(function(){
                    var uploader_tab_<?php echo ($group_k); ?>_upload_<?php echo ($tab_k); ?> = WebUploader.create({
                        ...
                        resize: false,                                                                     // 不压缩image, 默认如果是jpeg，文件上传前会压缩一把再上传！
                        //fileNumLimit: 1,                                                                 // 验证文件总数量, 超出则不允许加入队列
                        fileSingleSizeLimit:<?php echo $tab_form['extra']['self']['size'] ? : C('UPLOAD_IMAGE_SIZE'); ?>*1024*1024, // 验证单个文件大小是否超出限制, 超出则不允许加入队列
                        // 文件过滤
                        accept: {
                            title: 'Images',
                            extensions: "<?php echo $tab_form['extra']['self']['ext'] ? : 'gif,jpg,jpeg,bmp,png'; ?>",
                            mimeTypes: 'image/gif,image/jpg,image/jpeg,image/bmp,image/png'
                        }
                    });
                    ...
                    // 上传错误
                    uploader_tab_<?php echo ($group_k); ?>_upload_<?php echo ($tab_k); ?>.on("error",function (type){
                        if (type=="Q_TYPE_DENIED") {
                            $.alertMessager('该文件格式不支持');
                        } else if(type=="F_EXCEED_SIZE") {
                            $.alertMessager("文件大小不允许超过<?php echo C('UPLOAD_IMAGE_SIZE');?>MB");
...
function noworder(){
$.get("<?php echo U('Admin/Order/countnow');?>", { t: Math.random() }, function (count) {
		if(count>0){
			$("#duSound")[0].play();
		}
});
...
<audio src="/Public/images/duSound.wav" id="duSound" style="display:none;"></audio>
</body>
</html>